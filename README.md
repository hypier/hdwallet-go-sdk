...
hdwallet is a crypto hierarchical-deterministic wallet, implemented using golang. Implemented private key management, transaction signature, and tools related to eth, btc and trx.

Using a low coupling hierarchical structure, each specific function can be expanded according to requirements. Can be combined with hdwallet-go-service to achieve business layer functionality
...
```
cd existing_repo
git remote add origin https://github.com/hypier/hdwallet-go-sdk.git
git branch -M main
...
- [ ] [Set up project integrations](http://hypier.fun/hdwallet/hdwallet-go-sdkdubhe/dubhe-go-sdk/-/settings/integrations)
