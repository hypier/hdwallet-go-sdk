...
import (
	"errors"
	"hypier.fun/hdwallet/hdwallet-go-sdk/ext/ens/contracts/auctionregistrar"
	"hypier.fun/hdwallet/hdwallet-go-sdk/ext/ens/contracts/registry"
...
func CreateRegistrySession(chainID *big.Int, wallet *accounts.Wallet, account *accounts.Account, passphrase string, contract *registry.Contract, gasPrice *big.Int) *registry.ContractSession {
	// Create a signer
	signer := utils.AccountSigner(chainID, wallet, account, passphrase)
